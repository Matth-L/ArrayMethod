...
const { attributAge, agePlusGrandQue, tabNom, sexChoose, tabAge } = require('./utils.js');

let tableauDeNom = tabNom(PEOPLE);
// console.log(tableauDeNom); //fonctionne 
...
// console.log(tabPlusDe20AnsNom); fonctionne